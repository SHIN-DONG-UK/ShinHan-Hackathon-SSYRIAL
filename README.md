...
❕ 주요 해결법  
1, 2. 신한은행에서는 고령층을 위한 ATM기기를 운영하고 있다. 고령층을 위한 기기인 만큼, 고령층에 적합한 은행 업무가 들어가 있을 가능성이 높다. 
...
4. 프론트엔드 셀 회의 결과, 기존 인증 방식은 동의 절차에 대한 설명 없이 사용자에게 정보를 요구해 불안감을 유발한다는 문제가 제기되었다. 이를 해결하기 위해, 동의를 요청하기 전에 동의가 필요한 이유와 발생할 수 있는 사고 예시를 제시하여 정당성을 부여하였고, 제공해야 할 정보도 사전에 안내하여 사용자의 불안감을 줄였다. 또한, 고령층 사용자 대상임을 고려해 음성 안내를 추가하고, 손자뻘의 친근한 음성으로 안내하도록 AI 음성 합성 서비스를 활용하였다.
